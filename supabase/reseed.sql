-- Zenitech — Re-Seed Idempotent
-- Aman dijalankan ulang: hapus data lama dulu, baru insert ulang.
-- Hanya menyentuh tabel produk (tidak menghapus user/order).
...
-- 2. Re-insert dari seed
-- (isi di bawah ini disalin persis dari supabase/seed.sql)
...
INSERT INTO public.products (id, category_id, name, slug, description, base_price, is_active) VALUES
  ('a1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'iPhone 16 Pro Max', 'iphone-16-pro-max',
    'iPhone terbaru dengan chip A18 Pro, kamera 48MP, layar Super Retina XDR 6.9 inci, dan baterai tahan lama sepanjang hari.',
    21999000, true),
  ('a1111111-1111-1111-1111-111111111112', '11111111-1111-1111-1111-111111111111', 'iPhone 16', 'iphone-16',
    'iPhone dengan chip A18, kamera ganda 48MP, Dynamic Island, dan desain aluminium premium dengan pilihan warna cerah.',
    15999000, true),
  ('a1111111-1111-1111-1111-111111111113', '11111111-1111-1111-1111-111111111111', 'iPhone 15', 'iphone-15',
    'iPhone dengan chip A16 Bionic, kamera utama 48MP, USB-C, dan Dynamic Island untuk pengalaman yang lebih immersive.',
    13999000, true),
  ('a2222222-2222-2222-2222-222222222221', '22222222-2222-2222-2222-222222222222', 'MacBook Air M3 13"', 'macbook-air-m3-13',
    'Laptop tipis dan ringan dengan chip M3 yang powerful, layar Liquid Retina 13.6 inci, dan baterai hingga 18 jam.',
    18499000, true),
  ('a2222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'MacBook Pro M4 14"', 'macbook-pro-m4-14',
    'Laptop profesional dengan chip M4 Pro, layar Liquid Retina XDR 14 inci, dan performa luar biasa untuk creative work.',
    29999000, true),
  ('a3333333-3333-3333-3333-333333333331', '33333333-3333-3333-3333-333333333333', 'iPad Pro M4 11"', 'ipad-pro-m4-11',
    'iPad paling powerful dengan chip M4, layar Ultra Retina XDR 11 inci, dan mendukung Apple Pencil Pro.',
    17499000, true),
  ('a4444444-4444-4444-4444-444444444441', '44444444-4444-4444-4444-444444444444', 'Apple Watch Series 10', 'apple-watch-series-10',
    'Smartwatch dengan layar Always-On Retina yang lebih besar, sensor kesehatan lengkap, dan tahan air hingga 50 meter.',
    6499000, true),
  ('a5555555-5555-5555-5555-555555555551', '55555555-5555-5555-5555-555555555555', 'AirPods Pro 2', 'airpods-pro-2',
    'Earbuds dengan Active Noise Cancellation, Adaptive Audio, dan charging case USB-C dengan speaker untuk Find My.',
    4299000, true),
  ('a5555555-5555-5555-5555-555555555552', '55555555-5555-5555-5555-555555555555', 'Apple Pencil Pro', 'apple-pencil-pro',
...
-- 3. Hasil verifikasi (akan tampil setelah COMMIT)
COMMIT;
